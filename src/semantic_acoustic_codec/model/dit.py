...
class AcousticDiT(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if repa_feature_dim is None:
            ...
            repa_student_layer = (layers + 1) // 2 if repa_student_layer is None else repa_student_layer
        ...
        self.repa_projection = None if repa_feature_dim is None else nn.Linear(hidden_dim, repa_feature_dim)
    ...
    def forward(
        ...
        *,
        ...
        velocity, _ = self._forward(x_t, t, condition=condition, mask=mask)
        return velocity
    ...
    def forward_with_features(
        ...
        *,
        ...
        velocity, representation = self._forward(x_t, t, condition=condition, mask=mask)
    ...
    def _forward(
        ...
        *,
        ...
        if not bool(mask.any(dim=1).all()):
            raise ValueError("each acoustic sequence must contain at least one valid frame")
...
class RectifiedFlowRuntime:
    """Small local flow runtime used until an anytrain runtime is injected."""
