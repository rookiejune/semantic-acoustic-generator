...
class _FlowFeatureGenerator(FMFeatureGenerator):
    ...
    def feature_loss_from_condition(
        ...
        *,
        ...
        target = _normalized_features(target_features, target_mask, feature_mean, feature_std)
...
def _fm_sample_inputs(
    ...
    target_unconditional, unconditional_mask = _aligned_condition(unconditional_condition, mask)
