...
FACTOR_QWEN_SAMPLE_LIMIT="${FACTOR_QWEN_SAMPLE_LIMIT:-10000}"
FACTOR_QWEN_BATCH_SIZE="${FACTOR_QWEN_BATCH_SIZE:-32}"
FACTOR_QWEN_MAX_STEPS="${FACTOR_QWEN_MAX_STEPS:-20000}"
FACTOR_QWEN_OUTPUT_SUBDIR="${FACTOR_QWEN_OUTPUT_SUBDIR:-015/depth-qwen-baseline-2cb-${FACTOR_QWEN_SAMPLE_LIMIT}-${FACTOR_QWEN_MAX_STEPS}}"

echo '{"event":"job.launch","project":"semantic-acoustic-generator","experiment":"015","stage":"factor-depth-qwen-baseline-2cb"}'
