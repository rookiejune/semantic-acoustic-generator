...
FACTOR_RECURRENT_SAMPLE_LIMIT="${FACTOR_RECURRENT_SAMPLE_LIMIT:-9984}"
FACTOR_RECURRENT_BATCH_SIZE="${FACTOR_RECURRENT_BATCH_SIZE:-96}"
FACTOR_RECURRENT_MAX_STEPS="${FACTOR_RECURRENT_MAX_STEPS:-20000}"
FACTOR_RECURRENT_OUTPUT_SUBDIR="${FACTOR_RECURRENT_OUTPUT_SUBDIR:-015/depth-recurrent-original-2cb-${FACTOR_RECURRENT_SAMPLE_LIMIT}-${FACTOR_RECURRENT_MAX_STEPS}}"

echo '{"event":"job.launch","project":"semantic-acoustic-generator","experiment":"015","stage":"factor-depth-recurrent-original-2cb"}'
